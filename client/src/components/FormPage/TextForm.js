...
const TextForm = ({validated,errors,isReadOnly,formData, setFormData}) => {
        ...
        <div className="formAlign">
            <Form validated={validated}>
                <Form.Group className="mb-3" controlId="form.University">
                    ...
                    onChange={(e)=> {setFormData({...formData, uniName:e.target.value}); delete errors.uniRepName;}}/>
                ...
                <Form.Group className="mb-3" controlId="form.FullName">
                    ...
                    onChange={(e)=> {setFormData({...formData,uniRepName:e.target.value}); delete errors.uniRepName;}}/>
                    <Form.Control.Feedback type="invalid">
                        {errors.uniRepName}
                    </Form.Control.Feedback>
                ...
                <Form.Group className="mb-3" controlId="form.JobTitle">
                    ...
                    onChange={(e)=> {setFormData({...formData,uniRepJobTitle:e.target.value}); delete errors.uniRepJobTitle;}}/>
                    <Form.Control.Feedback type="invalid">
                ...
                <Form.Group className="mb-3" controlId="form.EmailAddress">
                        ...
                        onChange={(e)=> {setFormData({...formData,uniRepEmail:e.target.value}); delete errors.uniRepEmail}}/>
                        <Form.Control.Feedback type="invalid">
                            {errors.uniRepEmail}
                        </Form.Control.Feedback>
                </Form.Group>
                ...
                <Form.Group className="mb-3" controlId="form.Region" >
                    ...
                    onChange={(e) => setFormData({...formData,uniRegion:e.target.value})}>
